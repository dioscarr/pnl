    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            using (var srvc = app.ApplicationServices.CreateScope())
            {
                ...
                //     context.Add(new Question { FormStepId = 11, TheQuestion = "Are you a U.S citizen?", Order = 1, AnswerTypeId = 1, isEnabled = true, CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, isDeleated = false, ModifiedBy = "admin" });
